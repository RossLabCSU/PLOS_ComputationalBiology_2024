...
def main():
    ...
    obs_df, org_to_domain = get_frequencies('TableS1_LCDfrequency_data_NumberOfProtsWithLCDs.tsv')
    scr_df, org_to_domain_scr = get_frequencies('TableS1_LCDfrequency_data_NumberOfProtsWithLCDs_SCRAMBLED.tsv')
