...
def main():
    ...
    output = open('TableS10_MeanPerResidueOccupancies_DomainsOfLife_AllOrganisms.tsv', 'w')
    output.write('\t'.join(['Domain of Life', 'LCD Class', 'Mean Per-Residue LCD Occupancy']) + '\n')
    ...
    for i, sec_aa in enumerate(amino_acids):
        ...
        for j, prim_aa in enumerate(amino_acids):
            ...
            for i, domain in enumerate(domains):
                ...
                output.write('\t'.join([domain, lcd_class, str(val)]) + '\n')
