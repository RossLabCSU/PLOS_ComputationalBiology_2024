...
def main():
    ...
    filename = 'AllDomains_VariedWindowSize_PerResidueLCDoccupancies.tsv'
...
def plot_categorical_matrix(matrix, data_type):
    ...
    plt.savefig('FigS20A_VariedWindowSize_' + data_type + '_CategoricalWinner.tif', bbox_inches='tight', dpi=600, pil_kwargs={'compression':'tiff_lzw'})
    plt.close()
